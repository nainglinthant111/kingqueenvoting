    ...
    <div className="container py-8">
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground">Manage the voting process and view real-time results.</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">King Candidates</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Queen Candidates</CardTitle>
        ...
        <Tabs defaultValue="king" className="w-full">
          <TabsList className="grid w-full max-w-md grid-cols-2">
            <TabsTrigger value="king">King Voting Stats</TabsTrigger>
            <TabsTrigger value="queen">Queen Voting Stats</TabsTrigger>
          </TabsList>
          <TabsContent value="king" className="mt-6">
            <Card>
              <CardHeader>
                <CardTitle>King Candidate Votes</CardTitle>
                <CardDescription>Real-time voting statistics for king candidates.</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="queen" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Real-time voting statistics for queen candidates.</CardDescription>
              </CardHeader>
              <CardContent className="pl-2">
                <VotingChart
                  data={[
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest voting and registration activity.</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="flex items-center gap-4">
                    ...
                    <div className="flex-1 space-y-1">
                      <p className="text-sm font-medium leading-none">User {100 + i}</p>
                      <p className="text-sm text-muted-foreground">
                        {i % 2 === 0 ? "Voted for a king candidate" : "Voted for a queen candidate"}
                      </p>
                    </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Current voting period and settings.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">April 15 - April 30, 2025</p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-sm font-medium">Show Results Publicly</p>
                    <Switch checked={true} />
                  </div>
                  <div className="flex items-center justify-between">
                    <p className="text-sm font-medium">Allow New Candidates</p>
                    <Switch checked={false} />
                  </div>
                </div>
              </div>
