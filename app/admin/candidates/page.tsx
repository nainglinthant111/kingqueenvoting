    ...
    return (
        <div className="container py-8">
            <div className="flex flex-col gap-8">
                <div className="flex flex-col md:flex-row justify-left items-center md:justify-between">
                    <div>
                        <h1 className="text-3xl font-bold">Candidates</h1>
                        <p className="text-muted-foreground">
                            Manage king and queen candidates for the voting
                            event.
                        </p>
                    </div>
                    <Button className="bg-purple-600 hover:bg-purple-700 mt-6 md:mt-0 ">
                    ...
                    >
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    View and manage all king candidates.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <Table>
                    ...
                    >
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    View and manage all queen candidates.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <Table>
